...
void generate_names(map *m) {
    ...
    const char *names[] = {
        ...
        "Megan", "Alex", "David Hasselhoff", "Socrates", "Plato", "XAE A-12", 
        "Mrs. Bee", "Clam Chowda", "Big Dawg", "Carl Quest", "Peta Chu", "Jebediah Kerman"
    };
    ...
    switch(c->type) {
        ...
        case PACER:
            ...
            if (m->characters[new_y][new_x] != NULL && m->characters[new_y][new_x]->type == PC) {
                battled = m->characters[new_y][new_x];
                new_x = c->x;
                new_y = c->y;
